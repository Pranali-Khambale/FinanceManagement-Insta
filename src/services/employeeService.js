  ...
  const employeeService = {
    ...
    // ─────────────────────────────────────────────────────────────────────────────
  // ADD THESE TWO METHODS inside employeeService object in employeeService.js
  // Place them after the sendRejoinInvite / checkRejoinLink methods
  // ─────────────────────────────────────────────────────────────────────────────

    // ════════════════════════════════════════════════════════════════════════════
    // DOCUMENT REVIEW — Dashboard section
    // Returns employees where ALL submitted docs have been accepted by HR.
    // Called by EmployeeManagement.jsx to populate the "Docs Reviewed" section
    // below the main employee table.
    // Backend: GET /api/employee-docs/reviewed
    // ════════════════════════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════════════════════════
    // PENDING DOC COUNT — badge on the nav/button
    // Returns the count of employees with at least one unreviewed doc.
    // Used by EmployeeManagement to show a badge next to "Pending Approvals".
    // Backend: GET /api/employee-docs/pending (already exists — just count the data)
    // ════════════════════════════════════════════════════════════════════════════

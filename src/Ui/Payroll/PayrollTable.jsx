...
//  7. NEW: Download PDF button added to PayslipViewModal actions
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100">
      ...
      <div className="px-6 pt-5 pb-0 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap pb-3 border-b border-slate-100">
          ...
          <span className="ml-auto text-xs text-slate-400 font-medium">
            {filtered.length} of{" "}
            {
              employees.filter((e) => tabMap[activeTab]?.includes(e.status))
                .length
            }{" "}
            employees
          </span>
      ...
      <div className="px-6 py-3 border-t border-slate-100 flex items-center justify-between flex-wrap gap-2">
        <p className="text-xs text-slate-400">
          ...
          &nbsp;·&nbsp;
          {forMonth} · {correctMonthDays} days &nbsp;·&nbsp; PF = 12% Emp + 13%
          Co. = 25% total &nbsp;·&nbsp; Gratuity = 4.81% of Basic &nbsp;·&nbsp;

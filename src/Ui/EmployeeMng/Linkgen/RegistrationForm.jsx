...
const RegistrationForm = () => {
  ...
  const validateStep = (step) => {
    ...
    if (step === 2) {
      ...
      if (!formData.position)
        newErrors.position = "Designation is required";
      if (!formData.joiningDate)
        newErrors.joiningDate = "Joining date is required";
      if (!formData.employmentType)
        newErrors.employmentType = "Employment type is required";

      // Telecom-specific required fields
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await employeeService.submitRegistration({ ...formData, linkId }, documents);
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
          ...
          <p className="text-gray-600">
            This registration link has expired. Please contact HR to get a new link.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-amber-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
          ...
          <p className="text-gray-600">
            This registration link has already been used. Please contact HR if you have any
            questions.
          </p>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
          ...
          <p className="text-gray-600">
            This registration link is not valid. Please contact HR for assistance.
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-4">
            Your registration has been submitted successfully. HR will review your application
            and you will be notified once it's approved.
          </p>
          {formData.email && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-4 text-left">
              ...
              <p className="text-xs text-blue-700">
                A confirmation email with a copy of your submitted details has been sent to{" "}

...
const PublicLinkModal = ({ onClose, showToast = () => {} }) => {
  ...
  const handleGenerateLink = async () => {
    ...
    try {
      ...
      setStep("input");
      setGenerateError(
        error.message || "Failed to generate registration link. Please try again."
      );
    }
  };
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoFocus
                    className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm transition-colors ${emailError ? "border-red-400 bg-red-50" : "border-gray-300"}`}
                  />
                </div>
                {emailError && (
              ...
              {email.trim() && (
                <div className={`rounded-xl px-4 py-3 border flex items-center gap-3 ${
                  ...
                  {!emailSent && !sendingEmail && (
                    <button onClick={handleSendEmailManually}
                  ...
                  {showEmailPreview && (
                    <div className="bg-white p-4 text-sm text-gray-700 space-y-2 border-t border-blue-100">
                      ...
                      <p className="text-gray-500 text-xs leading-relaxed">
                        Please use the link below to complete your registration form. Once submitted, our HR team will review and approve your profile within 1–2 business days.
                      </p>

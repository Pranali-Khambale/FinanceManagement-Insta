...
const hp = (e, name, handleInputChange) => {
...
const PersonalInformation = ({
  ...
  const handleAadharChange = (e) => {
    ...
    if (/^\d*$/.test(v) && v.length <= 12)
      handleInputChange({ target: { name: "aadhar", value: v } });
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="space-y-2">
            ...
            <PhoneField
              ...
              onChange={(e) => hp(e, "phone", handleInputChange)}
              error={errors.phone}
            />
          </div>
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <PhoneField
              ...
              onChange={(e) => hp(e, "altPhone", handleInputChange)}
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="space-y-2">
            ...
            <PhoneField
              ...
              onChange={(e) => hp(e, "familyContactNo", handleInputChange)}
          ...
          <div className="space-y-2">
            ...
            <PhoneField
              ...
              onChange={(e) =>
                hp(e, "familyEmployerContact", handleInputChange)
              }
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="space-y-2">
            ...
            <PhoneField
              ...
              onChange={(e) => hp(e, "emergencyContactNo", handleInputChange)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="space-y-2">
                ...
                <PhoneField
                  ...
                  onChange={(e) => hp(e, "permanentPhone", handleInputChange)}
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <PhoneField
                  ...
                  onChange={(e) => hp(e, "localPhone", handleInputChange)}

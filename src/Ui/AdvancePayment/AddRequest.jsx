...
//   PORTAL FIX: Modal is rendered via createPortal into document.body to
//     escape any parent stacking context that causes overlay issues.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function AddRequestModal({ onClose, onAdd, linkToken = null }) {
  ...
  // ── All modal JSX stored in variable so createPortal can wrap it ───────────
  const modalContent = (
    <>
      <style>{`

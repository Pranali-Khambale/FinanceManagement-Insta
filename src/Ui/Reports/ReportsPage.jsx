...
export default function ReportsPage() {
  const { data, loading, year, setYear, view, setView, refresh, currentYear } =
    useReportData();
  ...
  const xKey =
    view === "monthly" ? "month" : view === "quarterly" ? "shortLabel" : "year";
        ...
        >
          <div>
            ...
            <p style={{ margin: "4px 0 0", fontSize: 13, color: "#64748b" }}>
              Payroll &amp; Advance Payment analytics across all periods
            </p>
          </div>
          <div
            style={{
        ...
        <>
                    ...
                    series={[
                      {
                        name: "Total Payroll",
                        color: "#3b82f6",
                        data: viewData.map((d) => d.totalPayroll || 0),
                      },
                      {
                        name: "Net Payroll",
                        color: "#10b981",
                        data: viewData.map((d) => d.netPayroll || 0),
                      },
                    ]}
                    height={200}
                  />
                  ...
                  <LineChart
                    ...
                    series={[
                      ...
                      },
                      {
                        name: "Deductions",
                        color: "#ef4444",
                        data: viewData.map((d) => d.totalDeductions || 0),
                      },
                    ]}
                    height={200}
                  />
                  ...
                  series={[
                    {
                      ...
                      color: "#1d4ed8",
                      data: viewData.map(
                        (d) => d.employeesPaid || d.avgEmployees || 0,
                      ),
                    },
                  ]}
                  height={160}
          ...
          {tab === "advance" && (
            <>
                    ...
                    series={[
                      {
                        name: "Issued",
                        color: "#8b5cf6",
                        data: viewData.map((d) => d.advanceIssued || 0),
                      },
                      {
                        name: "Recovered",
                        color: "#06b6d4",
                        data: viewData.map((d) => d.advanceRecovered || 0),
                      },
                      {
                        name: "Pending",
                        color: "#f59e0b",
                        data: viewData.map((d) => d.advancePending || 0),
                      },
                    ]}
                    height={200}
                  />
              ...
              <Section title="Issued vs Recovered (Bar)">
                <BarChart
                  data={viewData}
                  xKey={xKey}
                  height={200}
              ...
              <Section title="Pending Advances Trend">
                <LineChart
                  labels={xLabels}
                  series={[
                    {
              ...
              >
                {[
                  {
                    label: "Recovery Rate",
                    value: `${((data.totals.recovered / data.totals.advance) * 100).toFixed(1)}%`,
                    color: "#10b981",
                    bg: "#ecfdf5",
                  },
                  {

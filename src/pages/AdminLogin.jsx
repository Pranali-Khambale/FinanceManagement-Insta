...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(`Welcome back, ${response.data?.user?.fullName || formData.username}!`, "success");
    ...
    <div style={{
      ...
      {toast && (
        <div style={{
          ...
          <span style={{ fontSize: 13, fontWeight: 500, flex: 1, color: toast.type === "success" ? "#15803d" : "#dc2626" }}>
            {toast.message}
          </span>
          <button onClick={() => setToast(null)} style={{ background: "none", border: "none", cursor: "pointer", color: "#94a3b8", padding: 0, display: "flex" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 26, fontWeight: 800, color: "#0f172a", margin: "0 0 28px", letterSpacing: "-0.5px" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              />
              {errors.username && <p style={{ fontSize: 12, color: "#ef4444", marginTop: 4 }}>{errors.username}</p>}
            </div>
            ...
            <div style={{ textAlign: "right", marginBottom: 24 }}>
              <button type="button" onClick={() => navigate("/admin/forgot-password")} style={{
                background: "none", border: "none", cursor: "pointer",
                fontSize: 13, color: "#3b82f6", fontWeight: 500, padding: 0,
              }}>
                Forgot password?
              </button>
            </div>
        ...
        <div style={{
          ...
          <p style={{ color: "rgba(255,255,255,0.80)", fontSize: 14, textAlign: "center", margin: "0 0 32px", lineHeight: 1.6 }}>
            Sign up and discover a great amount of new opportunities!
          </p>
          <button type="button" onClick={() => navigate("/register")} style={{
            padding: "11px 36px", background: "#fff", color: "#2563eb",
          ...
          <p style={{ position: "absolute", bottom: 20, color: "rgba(255,255,255,0.45)", fontSize: 10, letterSpacing: "1.5px", textTransform: "uppercase", textAlign: "center" }}>
